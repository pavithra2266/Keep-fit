...
export default function ExerciseCard(props) {
    ...
    function handleSetCount(){
        setCompletedSets((completedSets + 1)%6)
    }


  
  return (
    <div className='bg-slate-950 flex flex-col gap-4 rounded m-4 p-4 sm:flex-wrap'>
    <div className='flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4 '>
     <h4 className='text-3xl text-blue-400 sm:4xl md:text-4xl hidden sm:inline'>0{i+1}</h4>
